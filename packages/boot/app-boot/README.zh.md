...
供 app bin（[`dsh`](../../../apps/cli/README.zh.md)、[`dsh-acp-demo`](../../examples/acp-demo/README.zh.md) 与[桌面 sidecar](../../../apps/desktop/README.zh.md)）共用的启动粘合层：每个 bin 都是在这些辅助函数之上构建的精简自执行组合，并以自身诊断前缀参数化。这样，Loader 故障行为只由一处负责，不会在已发布产物之间逐渐分化。
