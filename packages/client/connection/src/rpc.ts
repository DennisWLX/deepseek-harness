...
export interface HostConnectionHandle {
  ...
  /**
   * Apply Connection's Host/Origin checks and WebSocket authentication to an
   * upgrade route.
   * @param request - headers from the HTTP upgrade request.
   * @returns rejection status, or undefined when the route may accept the upgrade.
   */
