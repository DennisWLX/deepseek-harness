...
export class RemoteStreamMuxClient {
  ...
  /**
   * @param protocols - WebSocket subprotocols required by the Connection transport.
   */
  constructor(private readonly protocols: readonly string[] = []) {}
  ...
  private connect(): Promise<WebSocket> {
    const socket = new WebSocket(remoteStreamUrl(), [...this.protocols])
